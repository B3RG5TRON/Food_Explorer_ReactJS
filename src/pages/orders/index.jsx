...
export function Orders() {
  ...
  function handleValueChangeDelete(newValue) {
    ...
    const updatedCartItems = JSON.parse(localStorage.getItem("@foodExplorer:cartItems")) || []
  ...
  useLayoutEffect(() => {
    if (typeof subtotal === "string") {
      const price = Number.parseFloat(subtotal.replace(",", "."))
                    ...
                    <div
                      ...
                      onKeyDown={(e) => {
                        if (e.key === "Enter" || e.key === " ") {
                          handleCheckBoxEconomicalShipping();
                        }
                      }}
                    >

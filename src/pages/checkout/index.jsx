...
export function Checkout() {
  ...
  useLayoutEffect(() => {
    ...
    setShippingPrice(Number.parseFloat(shippingValue))
  }, [])
              ...
              <div>
                ...
                <ContentForm>
                  ...
                  <div
                    ...
                    onKeyDown={handleCheckBoxEconomicalShipping}
                  ...
                  <div
                    ...
                    onKeyDown={handleCheckBoxFreeShipping}
                  >
                    <label className="checkbox-container">
                      <input
                        type="checkbox"
                    ...
                    <div>
                      ...
                      >
                        {valueOfEachInstallment.map((valueInstallment, index) => {
                          const key = `${(index + 1)}x-${valueInstallment.toFixed(2)}`;
                          return (
